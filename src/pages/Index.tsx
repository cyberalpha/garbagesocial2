...
const Index: React.FC = () => {
  ...
  const filteredPosts = posts.filter(post => {
    const matchesSearch = searchTerm === '' || post.title.toLowerCase().includes(searchTerm.toLowerCase()) || post.description.toLowerCase().includes(searchTerm.toLowerCase()) || post.location.address.toLowerCase().includes(searchTerm.toLowerCase());
          ...
          <section className="relative hero-gradient text-gray-800 py-16 rounded-xl shadow-sm">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="md:w-2/3">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  {user ? <Button size="lg" className="bg-primary text-white hover:bg-primary/90" asChild>
                      <a href="/new-post">Publicar Residuo</a>
                    </Button> : <Button size="lg" className="bg-primary text-white hover:bg-primary/90" asChild>
                      <a href="/auth">
            ...
            <div className="hidden lg:block absolute bottom-0 right-0 w-1/3 h-full">
              <div className="relative h-full">
                <img src="/lovable-uploads/075fd805-57c3-4529-9440-17306830124a.png" alt="Recycling Logo" className="absolute bottom-10 right-20 w-64 h-64 object-contain" />
              </div>
            </div>
          </section>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                    <div className="relative w-full md:w-1/2">
                      ...
                      <Input type="text" placeholder="Buscar por título, descripción o ubicación..." className="w-full pl-10" value={searchTerm} onChange={e => setSearchTerm(e.target.value)} />
                    </div>
              ...
              <section className="py-8">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  {loading ? <div className="text-center py-12">
                    ...
                    </div> : filteredPosts.length > 0 ? <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <section className="py-16 bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button size="lg"
              //variant="outline"
              className="bg-yellow-500 hover:bg-yellow-600 text-white" asChild>
